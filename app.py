...
# 0. 網頁基本設定與自動字型下載
# ==========================================
st.set_page_config(page_title="全校通用整合系統", layout="centered", page_icon="🏫")

# 🌟 隱藏 Streamlit 預設的側邊欄導覽，避免選單疊加兩層
st.markdown("""
    <style>
...
# ==========================================
# 🌟 功能 2：成績單產生器 (請在下方貼入您的原代碼)
# ==========================================
elif page == "成績單產生器":
    st.title("📝 成績單產生器")
    st.write("---")
    st.info("💡 請將您寫好的成績單產生器程式碼，完整貼在這個區塊下方。")
    # 把您原本用在成績單的程式碼貼在這邊
